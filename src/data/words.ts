// Valid 5-letter words that can be answers
export const ANSWER_WORDS = [
  ...
  'TEACH', 'TEAM', 'THANK', 'THEFT', 'THEIR', 'THEME', 'THERE', 'THESE', 'THICK', 'THING',
...
// All valid 5-letter words (including answers + common words)
export const VALID_WORDS = [
  ...
  'ABORT', 'ABOS', 'ABOUL', 'ABRAY', 'ABRIM', 'ABRIN', 'ABRIS', 'ABSEY', 'ABSIT', 'ABUNA',
  'ABUNE', 'ABURS', 'ABUSED', 'ABUSER', 'ABUSES', 'ABUTS', 'ABUZZ', 'ABYES', 'ABYSM', 'ABYSS',
  'ACAIS', 'ACARI', 'ACCAS', 'ACCOY', 'ACEDY', 'ACER', 'ACHES', 'ACHEY', 'ACIDS', 'ACIDY'
];
